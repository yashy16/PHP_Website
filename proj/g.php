...
<div class="container mt-5">
     <div class="row">
        ...
        <div class="col-sm-3 mb-2">
            <img src="images/P5.jpg" width="270px" height="220px">
        </div>
        <div class="col-sm-3">
            <img src="images/P6.jpg" width="270px" height="220px">
        </div>
        <div class="col-sm-3">
            <img src="images/P7.jpg" width="270px" height="220px">
        </div>
        <div class="col-sm-3">
            <img src="images/P8.jpg" width="270px" height="220px">
        </div>
        <div class="col-sm-3 mb-2">
